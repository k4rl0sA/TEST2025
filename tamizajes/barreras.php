...
function cmp_barreras(){
    ...
    $c[]=new cmp('fis_dispositivo_asistencia_cual','s','3','',$w.' DEv WhA '.$o,'Cual','fis_dispositivo_asistencia_cual',null,null,false,false,'','col-10');
    ...
    $c[]=new cmp('adm_demora_autorizacion_desc','a','255','',$w.' STa LaT '.$o,'Cual','adm_demora_autorizacion_desc',null,null,true,false,'','col-10');
