...
function cmp_barreras(){
    ...
    $c[]=new cmp('fis_usa_dispositivo_asistencia','s','3','',$w.' DEv '.$o,'Utiliza algún dispositivo de asistencia para la movilidad?','rta',null,null,true,true,'','col-10',"enabYes('fis_usa_dispositivo_asistencia','WhA');");
