...
function initBulkSelection(tableSelector, selectAllId, updateFn) {
    document.querySelectorAll(`${tableSelector} `).forEach(cb => {
        cb.onchange = updateFn;
    });
    const selectAll = document.getElementById(selectAllId);
    if (selectAll) selectAll.onchange = updateFn;
}
