...
function updateBulkActionsBar(tableSelector = '#roles-table', barId = 'bulk-actions-bar', countId = 'bulk-count') {
...
function initBulkSelection(tableSelector, selectAllId, updateFn) {
    document.querySelectorAll(`${tableSelector} .select-role`).forEach(cb => {
