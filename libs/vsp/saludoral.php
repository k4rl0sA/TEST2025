...
function gra_saludoral(){
  ...
  $campos = [
    'idpeople', 'fecha_seg', 'numsegui', 'evento', 'estado_s', 'motivo_estado', 'clasi_riesgo', 'sangra_cepilla', 'evide_anormal', 'explica_breve', 'urg_odonto',
    'estrategia_1', 'estrategia_2', 'acciones_1', 'desc_accion1', 'acciones_2', 'desc_accion2', 'acciones_3', 'desc_accion3', 'activa_ruta', 'ruta', 'novedades',
    'signos_covid', 'caso_afirmativo', 'otras_condiciones', 'observaciones', 'cierre_caso', 'motivo_cierre', 'fecha_cierre', 'mejora_practica', 'redu_riesgo_cierre',
  ...
  if(count($id)==4){
    // UPDATE
    $set = [
      'clasi_riesgo', 'sangra_cepilla', 'evide_anormal', 'explica_breve', 'urg_odonto', 'estrategia_1', 'estrategia_2', 'acciones_1', 'desc_accion1',
      'acciones_2', 'desc_accion2', 'acciones_3', 'desc_accion3', 'activa_ruta', 'ruta', 'novedades', 'signos_covid', 'caso_afirmativo', 'otras_condiciones',
      'observaciones', 'cierre_caso', 'motivo_cierre', 'fecha_cierre', 'mejora_practica', 'redu_riesgo_cierre', 'users_bina', 'equipo_bina'
    ];
    $params = [];
    ...
    $sql = "UPDATE vsp_saludoral SET "
      ...
      . "WHERE id_saludoral = ?";
    $params[] = ['type' => 's', 'value' => $id[0]]; // id_saludoral
    ...
    $sql = "INSERT INTO vsp_saludoral (
      id_saludoral, " . implode(', ', $campos) . "
    ) VALUES (
      NULL, $placeholders
    )";
    $rta = mysql_prepd($sql, $params);
  } else {
    $rta = "Error: id_saludoral inválido";
  }
  return $rta;
} 
