...
function cmp_segnoreg(){
  ...
  $c[]=new cmp('estado_seg','s',3,$d,$w.' sTa '.$o,'Estado','estado_seg',null,null,true,true,'','col-2',"enabFielSele(this,true,['motivo_estado'],['3']);enabFielSele(this,false,['prioridad'],['3']);enabFielSele(this,true,['prioridad'],['1']);etnFall();EnabEfec(this,['ges','cronicos','menor5','signosV','antrop','aspfin'],['Ob'],['nO'],['bL']);");//
  $c[]=new cmp('motivo_estado','s','3',$d,$w.' '.$o,'Motivo de Estado','motivo_estado',null,null,false,$x,'','col-2');
  $c[]=new cmp('prioridad','s',3,$d,$w.' '.$no,'Prioridad','prioridad',null,null,false,true,'','col-2',"enabPrioEtn();enCroGes();etnFall();");
  ...
  $c[]=new cmp('resul_gest','s',3,$d,$w.' '.$bl.' Pue '.$o,'Resultado De La Gestación','resul_gest',null,null,false,false,'','col-2',"enabNV();");
  $c[]=new cmp('peso_nacer','sd',5,$d,$w.' '.$bl.' Pue Nav '.$o,'Peso Al Nacer (Gr)','peso_nacer',null,null,false,false,'','col-2');
  ...
  $o='signosA';
  $c[]=new cmp('sistolica','sd',3,$d,$w.' '.$o,'Valor Sistolica (50 mmhg y 200 mmhg)','sistolica','rgxsisto',null,true,false,'','col-25');
  $c[]=new cmp('diastolica','sd',3,$d,$w.' '.$o,'Valor Diastolica (30 mmhg y 150 mmhg)','diastolica','rgxdiast',null,true,false,'','col-25');
  $o='signosV';
...
param_null($_POST['fum'] ?? '', 's'), // fechaultimamenstruacion
