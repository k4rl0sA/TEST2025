...
function cmp_segComp(){
  $rta ="<div class='encabezado seguiCom'>TABLA DE COMPROMISOS NO CUMPLIDOS</div>
	...
	$days=fechas_app('vivienda');
      ...
      $c[]=new cmp('fecha','d','3',$e,$w.' '.$o,'Fecha','fecha',null,null,true,true,'','col-5',"validDate(this,$days,0);");
      $c[]=new cmp('fecha','d','10',$e,$w.' '.$o,'fecha','fecha',null,'',true,true,'','col-15',"validDate(this,$days,0);");
