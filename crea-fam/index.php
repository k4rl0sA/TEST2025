...
<script src="../libs/js/a.js?v=2"></script>
<script src="../libs/js/x.js?v=17"></script>
...
WHERE`perfil` IN('ADM','AUXHOG','PROFAM','MEDICINA','ENFERMERIA','PSICOLOGIA','NUTRICION','TERAPEUTA','AMBIENTAL','ODONTOLOGIA','AGCAMBIO','AUXRELEVO','PSICLINICOS','PROAPO','EMBERA','GEO','TECNICO') and subred=(SELECT subred FROM usuarios where id_usuario='{$_SESSION['us_sds']}')  ORDER BY 2",$_SESSION['us_sds']);
...
<div class="col-2 menu-filtro" id='<?php echo$mod; ?>-fil'>
  ...
  <?php
    $filtro = in_array($perfil, ['ADM', 'SUPHOG', 'SUPEAC', 'PROAPO','GEO','TECNICO']);
