...
function gra_atencion() {
	...
	$id = divide($_POST['ida']);
	 ...
	 $obligatorios = ['idpeople', 'idf', 'fechaatencion', 'tipo_consulta', 'codigocups', 'finalidadconsulta', 'letra1', 'rango1', 'diagnostico1','metodo', 'anticonceptivo', 'planificacion', 'mestruacion', 'vih', 'resul_vih', 'hb', 'resul_hb', 'trepo_sifil', 'resul_sifil', 'pru_embarazo', 'resul_emba', 'estrategia'];
