...
// var_dump($c);
	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		if(validUser($c['ACCIONES'])){
			...
			$rta .="<li title='Barreras' Onclick=\"mostrar('barreras','pro',event,'','../tamizajes/barreras.php',7,'barreras');Color('datos-lis');\"><i class='fa-solid fa-road-barrier color-soporte ico' id='".$c['ACCIONES']."'></i> </li>";
