...
//  var_dump($c);
	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		$rta.="<li title='Validar Usuario' Onclick=\"mostrar('valperson','pro',event,'','valperson.php',7,'person');Color('datos-lis');\"><i class='fas fa-user-check ico' id='".$c['ACCIONES']."'></i> </li>";
