...
function lista_persons(){ //revisar
	// var_dump($_POST);
	$id=divide($_POST['id']);
		$sql="SELECT concat_ws('_',idpeople,$id[0]) ACCIONES,idpeople 'Cod Persona',concat_ws(' ',nombre1,nombre2,apellido1,apellido2) 'Nombre',FN_CATALOGODESC(18,eapb) EAPB, fecha_create Fecha_Creado,fecha_nacimiento Fecha_Nacimiento
		FROM `person` 
