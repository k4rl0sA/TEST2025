...
// var_dump($c);
	if ($a=='homes' && $b=='acciones'){
		...
		$rta.="<li title='Unidades Habitacionales'  Onclick=\"mostrar('unidadeshs','pro',event,'','../soporte/Unidades.php',4,'unidadeshs');Color('homes-lis');\"><i class='fa-solid fa-person-shelter ico' id='".$c['ACCIONES']."'></i></li>";
	}
