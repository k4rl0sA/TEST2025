...
function eventAsign($key) {
    ...
    $eventos = array(
	  ...
	  31 => ['icono' => 'discap', 'titulo' => 'RBC', 'modulo' => in_array($perfilUsuario,['AUXRELEVO','ADM']) ? 'discapacidad1' : 'discapacidad'],
	  ...
	  38 => ['icono' => 'salud1', 'titulo' => 'ACOMPAÑAMIENTO VBG', 'modulo' => in_array($perfilUsuario, ['PSICOLOGIA','ADM']) ? 'feminicidio1' : 'feminicidio'],
