...
// var_dump($c);
	if ($a=='homes' && $b=='acciones'){
 	...
 	if ($a=='famili-lis' && $b=='acciones'){
		...
		$rta.="<li title='Interlocales' Onclick=\"mostrar('trasladint','pro',event,'','../soporte/interloc.php',4,'Interlocales');Color('datos-lis');\"><i class='fa-reply-all ico' id='".$c['Cod_Familiar']."'></i> </li>";//soporte traslados
	}
