	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		if(validUser($c['ACCIONES'])){
			...
			// if (medicamAtenci($c['ACCIONES'])) {
				...
				$rta .="<li title='Laboratorios' onclick=\"mostrar('laboratorios','pro',event,'','../servicios_complem/laboratorios.php',7,'Control Medicamentos');Color('datos-lis')\"><i class='fa-solid fa-flask-vial ico' id='{$c['ACCIONES']}'></i></li>";
			// }
