	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		if(validUser($c['ACCIONES'])){
			...
			if (is_array($tamiz) && in_array('tamsoledad', $tamiz)) {
				$rta .= acceso('tamsoledad') ? "<li title='Soledad Social' onclick=\"mostrar('tamsoledad','pro',event,'','../tamizajes/soledad.php',7,'Soledad Social');Color('datos-lis');\"><i class='fa-solid fa-person-walking-luggage ico' id='{$c['ACCIONES']}'></i></li>":"";
			}
