...
//  var_dump($c);
	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		if(validUser($c['ACCIONES'])){
			...
			$rta .= acceso('tamvalories') ? "<li title='Valoración del Riesgo' onclick=\"mostrar('tamvalories','pro',event,'','../valor-ries/lib.php',7,'rqc');Color('datos-lis');\"><i class='fa-solid fa-person-skating ico' id='{$c['ACCIONES']}'></i></li>":"";
			$rta .= acceso('tamcarlos') ? "<li title='Tamizaje Carlos Crafft' onclick=\"mostrar('tamcarlos','pro',event,'','../valor-ries/lib.php',7,'rqc');Color('datos-lis');\"><i class='fas fa-clipboard-list ico' id='{$c['ACCIONES']}'></i></li>":"";
		}
	}
