...
// var_dump($c);
	if ($a=='homes' && $b=='acciones'){
		...
		//   <i class="fa-solid fa-person-shelter"></i>   JCURREA 23-09-2025 $rta.="<li title='Crear Integrante Familia' Onclick=\"mostrar('person','pro',event,'','lib.php',7,'person');Color('famili-lis');\"><i class='fa-solid fa-person-circle-plus ico' id='".$c['Cod_Familiar']."'></i></li>";
	}
