...
function cmp_resultLab(){
  ...
  $w="resultados";
	...
	$days=fechas_app('vivienda');
      ...
      $c[]=new cmp('fecha_resul','d',10,$e,$w.' RTa  '.$o,'Fecha de Resultado','fecha_resul',null,'',false,false,'','col-5');
      ...
      $c[]=new cmp('gest_cump','d',3,$e,$w.' dCR '.$o,'Fecha Gestión','gest_cump',null,'',false,false,'','col-3');
