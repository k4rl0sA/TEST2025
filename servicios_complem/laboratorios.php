...
function formato_dato($a,$b,$c,$d){
  ...
  var_dump($c);
    ...
    if ($a=='laboratorios' && $b=='cod laboratorio'){
        ...
        $rta .= "<li title='Resultado Laboratorios' onclick=\"mostrar('resultados','pro',event,'','../servicios_complem/laboratorios.php',3,'Resultados del Laboratorio');Color('datos-lis');\"><i class='fa-solid fa-file-waweform ico' id='".$c['Cod Laboratorio']."'></i></li>":"OK";
