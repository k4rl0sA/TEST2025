...
function formato_dato($a,$b,$c,$d){
  ...
  var_dump($b);
    ...
    if ($a=='laboratorios' && $b=='cod laboratorio'){
        ...
        $rta.=['tomado']=='SI'?"<li title='Resultado Laboratorios' Onclick=\"mostrar('resultados','pro',event,'','../servicios_complem/laboratorios.php',4,'resultLab');Color('datos-lis');\"><i class='fa-solid fa-file-waweform ico' id='".$c['Cod Laboratorio']."'></i> </li>":'';
        $rta.="</nav>";
    }
    return $rta;
}
