...
function formato_dato($a,$b,$c,$d){
  ...
  //  var_dump($b);
    ...
    if ($a=='laboratorios' && $b=='cod laboratorio'){
        ...
        $rta.="<li title='Resultado Laboratorios' Onclick=\"mostrar('trasladint','pro',event,'','../soporte/interloc.php',4,'Interlocales');Color('datos-lis');\"><i class='fa-solid fa-file-waweform ico' id='".$c['Cod Laboratorio']."'></i> </li>";
        $rta.="</nav>";
    }
    return $rta;
}
