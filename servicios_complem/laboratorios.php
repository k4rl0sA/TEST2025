...
$rta.="<li ><i class='fa-solid fa-house-medical-circle-check ico' title='Seguimiento a Compromisos' id='".$c['Cod Laboratorio']."' Onclick=\"mostrar('resultLab','pro',event,'','../servicios_complem/resultados.php',7,'Seguimiento a Compromisos');\"></i></li>";
