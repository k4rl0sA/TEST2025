...
function formato_dato($a, $b, $c, $d) {
  ...
  if ($a == 'laboratorios' && $b == 'cod laboratorio') {
    ...
    $rta .= "<li title='Resultado Laboratorios' onclick=\"mostrar('resultLab','pro',event,'','../servicios_complem/laboratorios.php',3,'Resultados del Laboratorio');Color('datos-lis');\"><i class='fa-solid fa-file-waveform ico' id='{$c['Cod Laboratorio']}'></i></li>";
