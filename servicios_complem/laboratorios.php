...
function lis_laboratorios(){
    ...
    $sql="SELECT id_lab 'Cod Laboratorio', idpeople, tipo_lab, otro_lab, fecha_orden, lab_tomado, fecha_toma, cuenta_resul, fecha_resul, dato_crit, gestion, gest_cump, obs
          FROM hog_laboratorios 
          WHERE idpeople='{$id[0]}' AND estado='A'";
...
function cmp_laboratorios(){
    ...
    $c[]=new cmp('fecha_toma','d',10,$e,$w.' '.$o,'Fecha de Toma','fecha_toma',null,'',true,false,'','col-2');
    $c[]=new cmp('cuenta_resul','s',3,$e,$w.' '.$o,'¿Cuenta con resultado?','cuenta_resul',null,'',true,true,'','col-2');
    $c[]=new cmp('fecha_resul','d',10,$e,$w.' '.$o,'Fecha de Resultado','fecha_resul',null,'',true,false,'','col-2');
