...
$rta.="<li ><i class='fa-solid fa-house-medical-circle-check ico' title='Seguimiento a Compromisos' id='".$c['Cod Laboratorio']."' Onclick=\"mostrar('segComp','pro',event,'','plnsegcon.php',7,'Seguimiento a Compromisos');\"></i></li>";
