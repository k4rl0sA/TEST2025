...
$digitadores=opc_sql("SELECT `id_usuario`,nombre FROM `usuarios` WHERE subred=(SELECT subred FROM usuarios where id_usuario='{$_SESSION['us_sds']}') ORDER BY 2",$_SESSION['us_sds']);
?>
