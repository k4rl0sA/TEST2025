    ...
    roles.forEach(role => {
        ...
        <td style="position:relative;">
                ...
                <div class="action-menu" id="action-menu-${role.id_rol}">
                    <button class="edit-btn" onclick="editRole(${role.id_rol})"><i class="fa fa-edit"></i> Editar</button>
                    <button class="delete-btn" onclick="deleteRole(${role.id_rol})"><i class="fa fa-trash"></i> Eliminar</button>
                </div>
            </td>
