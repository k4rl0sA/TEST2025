...
function cmp_atencionP(){
	...
	$c[]=new cmp('fechaingreso','d',20,$x,$w.' '.$o,'Fecha del Ingreso','fechaingreso',null,'',true,true,'','col-15',"validDate(this,$days,0);");
	...
	$c[]=new cmp('letra2','s','3',$x,$w.' '.$o,'Letra CIE(2)','letra2',null,null,false,true,'','col-1',"selectDepend('letra2','rango2','../atenciones/atencionPsic.php');");
 	$c[]=new cmp('rango2','s','3',$x,$w.' '.$o,'Tipo2','rango2',null,null,false,true,'','col-45',"selectDepend('rango2','diagnostico2','../atenciones/atencionPsic.php');");
	...
	$c[]=new cmp('daño','s',3,$x,$w.' lab '.$o,'¿Ha pensado en hacerse daño o en que sería mejor no vivir?','aler',null,'',false,true,'','col-10');
	$c[]=new cmp('tristeza','s',3,$x,$w.' med '.$o,'¿Ha sentido tristeza, nerviosismo o preocupación excesiva en el último mes?','aler',null,'',false,true,'','col-10');
	$c[]=new cmp('violencia','s',3,$x,$w.' med '.$o,'¿Ha experimentado violencia física, emocional o sexual?','aler',null,'',false,true,'','col-10');
