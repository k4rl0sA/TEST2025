...
function cmp_atencion(){
	...
	$c[]=new cmp('letra1','s','3',$x,$w.' '.$o,'Letra CIE(1)','letra1',null,null,true,true,'','col-1',"valPyd(this,'tipo_consulta');valResol('tipo_consulta','letra1');selectDepend('letra1','rango1','../atenciones/atencionOdon.php');");//,['rango1']
   ...
   function lis_atencion(){
	...
	WHERE F.idpeople ='{$id[0]}'";
		...
		// echo $sql;
			...
			return create_table($total,$datos["responseResult"],"atencion",$regxPag,'../atenciones/atencionOdon.php');
  ...
  function formato_dato($a,$b,$c,$d){
   ...
   // var_dump($a);   
	   if($a=='atencion' && $b=='acciones'){
		   ...
		   $rta.="<li class='icono editar ' title='Generar Consulta' id='".$c['ACCIONES']."' Onclick=\"setTimeout(getData,1000,'atencion',event,this,['idpersona','tipo_doc'],'../atenciones/atencionOdon.php');Color('datos-lis');\"></li>";
	   }
	return $rta;
   }
