...
function cmp_atencionM(){
	$rta="";
	$rta .="<div class='encabezado atencion'>Consultas realizadas al paciente</div><div class='contenido' id='atencionM-lis' >".lis_atencionM()."</div></div>";
	$hoy=date('Y-m-d');
...
$o='complementarios';
	...
	$c[]=new cmp('laboratorios','s',3,$x,$w.' PRi '.$o,'Laboratorio','aler',null,'',false,false,'','col-2');
	$c[]=new cmp('medicamentos','s',3,$x,$w.' PRi '.$o,'Medicamentos','aler',null,'',false,false,'','col-2');
...
function cap_menus($a,$b='cap',$con='con') {
	$rta = "";
	$acc=rol($a);
	  if($a=='atencionM' && isset($acc['crear']) && $acc['crear']=='SI'){
