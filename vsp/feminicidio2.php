...
function focus_feminicidio2(){
  return 'feminicidio2';
 }
 
 
 function men_feminicidio2(){
  $rta=cap_menus('feminicidio2','pro');
  return $rta;
 }
 ...
 function cap_menus($a,$b='cap',$con='con') {
   $rta = ""; 
   $acc=rol($a);
   	if ($a=='feminicidio2'  && isset($acc['crear']) && $acc['crear']=='SI'){  
	 $rta .= "<li class='icono feminicidio2 grabar'      title='Grabar'          OnClick=\"grabar('$a',this);\"></li>";
    }
  return $rta;
 }


 FUNCTION lis_feminicidio2(){
	// var_dump($_POST['id']);
	$id = isset($_POST['id']) ? divide($_POST['id']) : (isset($_POST['id_feminicidio2']) ? divide($_POST['id_feminicidio2']) : null);
  ...
  WHERE A.estado = 'A' AND A.idpeople='".$id[0]."'");
	...
	$regxPag=4;
  $pag=(isset($_POST['pag-feminicidio2']))? ($_POST['pag-feminicidio2']-1)* $regxPag:0;
...
FROM vsp_femini A
  ...
  LEFT JOIN   person P ON A.idpeople=P.idpeople";
	...
	return create_table($total,$datos["responseResult"],"feminicidio2",$regxPag,'../vsp/feminicidio2.php');
   }


function cmp_feminicidio2(){
	$rta="<div class='encabezado'>TABLA SEGUIMIENTOS FEMINICIDIO - EVALUACIÓN PSICOLÓGICA</div>
	<div class='contenido' id='feminicidio2-lis'>".lis_feminicidio2()."</div></div>";
	$w='feminicidio2';
  $d='';
	$o='inf';
//agregar en todas
  ...
  $c[]=new cmp('numsegui','s','3',$d,$w.' '.$o,'Seguimiento N°','numsegui',null,null,true,true,'','col-2',"staEfe('numsegui','sta');EnabEfec(this,['acc'],['Ob'],['nO'],['bL'])");
...
//fin agregar en todas
    ...
    $c[]=new cmp('acciones_1','s','3',$d,$w.' '.$o,'Accion 1','acciones_1',null,null,false,$x,'','col-5','selectDepend(\'acciones_1\',\'desc_accion1\',\'../vsp/feminicidio2.php\');');
    $c[]=new cmp('desc_accion1','s','3',$d,$w.' '.$o,'Descripcion Accion 1','desc_accion1',null,null,false,$x,'','col-5');
    $c[]=new cmp('acciones_2','s','3',$d,$w.' '.$no.' '.$o,'Accion 2','acciones_2',null,null,false,$x,'','col-5','selectDepend(\'acciones_2\',\'desc_accion2\',\'../vsp/feminicidio2.php\');');
    $c[]=new cmp('desc_accion2','s','3',$d,$w.' '.$no.' '.$o,'Descripcion Accion 2','desc_accion2',null,null,false,$x,'','col-5');
    $c[]=new cmp('acciones_3','s','3',$d,$w.' '.$no.' '.$o,'Accion 3','acciones_3',null,null,false,$x,'','col-5','selectDepend(\'acciones_3\',\'desc_accion3\',\'../vsp/feminicidio2.php\');');
...
// var_dump($a);
// var_dump($rta);
	if ($a=='feminicidio2' && $b=='acciones'){
		$rta="<nav class=getData'menu right'>";	
		$rta.="<li class='icono editar' title='Editar' id='".$c['ACCIONES']."' Onclick=\"setTimeout(getData,500,'feminicidio2',event,this,['fecha_seg','numsegui','evento','estado_s','motivo_estado','cierre_caso'],'../vsp/feminicidio2.php');\"></li>";
	}
