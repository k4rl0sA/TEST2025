...
function cmp_discapacidad(){
  ...
  $c[]=new cmp('motivo_estado','s','3',$d,$w.' '.$o,'Motivo de Estado','motivo_estado',null,null,false,$x,'','col-2');
    ...
    $c[]=new cmp('cuantos_cuidadores','s','3',$d,$w.' CuI '.$o,'Cuantas personas ejercen labor de cuidador?','cuantos_cuidadores',null,null,false,$x,'','col-2');
    $c[]=new cmp('acep_relevo','s','3',$d,$w.' CuI '.$o,'¿el cuidador acepta el relevo?','rta',null,null,false,$x,'','col-2');
    $c[]=new cmp('cod_cuidador','s','18',$d,$w.' CuI '.$o,'Código del cuidador','cod_cuidador',null,null,false,$x,'','col-2');
    $c[]=new cmp('antece','s','3',$d,$w.' CuI '.$o,'Cuenta con antecedentes patológicos','rta',null,null,false,$x,'','col-2',"enabOthSi('antece','AnT');");
    $c[]=new cmp('ante_cuidador','s','3',$d,$w.' AnT CuI '.$o,'Antecedente patológico','ante_cuidador',null,null,false,$x,'','col-2',"enabOthSi('ante_cuidador','OtR');");
    $c[]=new cmp('otro_ante','t','100',$d,$w.' OtR AnT CuI '.$o,'Otro, ¿cuál?','otro_ante',null,null,false,$x,'','col-3');
    $c[]=new cmp('pers_cuida','s','3',$d,$w.' CuI '.$o,'Tiene más personas al cuidado','rta',null,null,false,$x,'','col-2',"enabOthSi('pers_cuida','PerS');");
    $c[]=new cmp('num_pers','s','3',$d,$w.' PerS CuI '.$o,'Número de personas','num_pers',null,null,false,$x,'','col-2');
    $c[]=new cmp('descanso','s','3',$d,$w.' CuI '.$o,'¿Ha tenido tiempo para descansar o cuidar su salud?','rta',null,null,false,$x,'','col-3');
    $c[]=new cmp('apoyo_tec','s','3',$d,$w.' CuI '.$o,'¿Considera que requiere apoyo o capacitación en alguna técnica de cuidado?','rta',null,null,false,$x,'','col-4');
    $c[]=new cmp('alarma','s','3',$d,$w.' CuI '.$o,'¿Sabe identificar signos de alarma?','rta',null,null,false,$x,'','col-3');
