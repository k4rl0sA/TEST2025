...
function cmp_mme(){
  ...
  $o='gest';
    ...
    $c[]=new cmp('talla','sd',5,$d,$w.' pRe IMc pYT  '.$o,'Talla (Cm) Mín=40 - Máx=210','fta','rgxtalm','###.#',false,$x,'','col-2',"calImc('peso','talla','imc');");
    ...
    $c[]=new cmp('equipo_bina','m','60',$d,$w.' '.$ob.' '.$o,'Usuarios Equipo','bina',null,null,false,true,'','col-5');
