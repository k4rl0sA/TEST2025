...
function gra_gestantes(){
  ...
  $campos = [
    ...
    'desc_accion2', 'acciones_3', 'desc_accion3', 'activa_ruta', 'ruta', 'novedades', 'signos_covid', 'caso_afirmativo',
  ...
  $campos_fecha_null = ['fecha_obstetrica', 'fecha_cierre', 'fecha_update', 'peso', 'talla','imc','peso_nacer'];
  if(count($id)==4){
    // UPDATE
    $set = [
    ...
    $sql = "UPDATE vsp_gestantes SET "
      ...
      . "WHERE id_gestante = ?";
    $params[] = ['type' => 's', 'value' => $id[0]]; // id_gestante
