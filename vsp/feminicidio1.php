...
function focus_feminicidio1(){
  return 'feminicidio1';
 }
 
 
 function men_feminicidio1(){
  $rta=cap_menus('feminicidio1','pro');
  return $rta;
 }
 ...
 function cap_menus($a,$b='cap',$con='con') {
   $rta = ""; 
   $acc=rol($a);
   	if ($a=='feminicidio1'  && isset($acc['crear']) && $acc['crear']=='SI'){  
	 $rta .= "<li class='icono feminicidio1 grabar'      title='Grabar'          OnClick=\"grabar('$a',this);\"></li>";
    }
  return $rta;
 }


 FUNCTION lis_feminicidio1(){
	// var_dump($_POST['id']);
	$id = isset($_POST['id']) ? divide($_POST['id']) : (isset($_POST['id_feminicidio1']) ? divide($_POST['id_feminicidio1']) : null);
  ...
  WHERE A.estado = 'A' AND A.idpeople='".$id[0]."'");
	...
	$regxPag=4;
  $pag=(isset($_POST['pag-feminicidio1']))? ($_POST['pag-feminicidio1']-1)* $regxPag:0;
...
FROM vsp_femini A
  ...
  LEFT JOIN   person P ON A.idpeople=P.idpeople";
	...
	return create_table($total,$datos["responseResult"],"feminicidio1",$regxPag,'../vsp/feminicidio1.php');
   }


function cmp_feminicidio1(){
	$rta="<div class='encabezado'>TABLA SEGUIMIENTOS FEMINICIDIO - EVALUACIÓN PSICOLÓGICA</div>
	<div class='contenido' id='feminicidio1-lis'>".lis_feminicidio1()."</div></div>";
	$w='feminicidio1';
  $d='';
	$o='inf';
//agregar en todas
...
//fin agregar en todas
    ...
    $c[]=new cmp('acciones_1','s','3',$d,$w.' '.$o,'Accion 1','acciones_1',null,null,false,$x,'','col-5','selectDepend(\'acciones_1\',\'desc_accion1\',\'../vsp/feminicidio1.php\');');
    $c[]=new cmp('desc_accion1','s','3',$d,$w.' '.$o,'Descripcion Accion 1','desc_accion1',null,null,false,$x,'','col-5');
    $c[]=new cmp('acciones_2','s','3',$d,$w.' '.$no.' '.$o,'Accion 2','acciones_2',null,null,false,$x,'','col-5','selectDepend(\'acciones_2\',\'desc_accion2\',\'../vsp/feminicidio1.php\');');
    $c[]=new cmp('desc_accion2','s','3',$d,$w.' '.$no.' '.$o,'Descripcion Accion 2','desc_accion2',null,null,false,$x,'','col-5');
    $c[]=new cmp('acciones_3','s','3',$d,$w.' '.$no.' '.$o,'Accion 3','acciones_3',null,null,false,$x,'','col-5','selectDepend(\'acciones_3\',\'desc_accion3\',\'../vsp/feminicidio1.php\');');
...
function opc_equ(){
  ...
  function gra_feminicidio1() {
    ...
    $campos = [
        ...
        'reg_emociones', 'bloqueo_emocional', 'tecnicas_manejo', 'cambios_autovaloracion', 'baja_motivacion', 'pensamientos_repetitivos', 'apoyo_seguro', 'barreras_apoyo',
...
// var_dump($a);
// var_dump($rta);
	if ($a=='feminicidio1' && $b=='acciones'){
		$rta="<nav class=getData'menu right'>";	
		$rta.="<li class='icono editar' title='Editar' id='".$c['ACCIONES']."' Onclick=\"setTimeout(getData,500,'feminicidio1',event,this,['fecha_seg','numsegui','evento','estado_s','motivo_estado','cierre_caso'],'../vsp/feminicidio1.php');\"></li>";
	}
