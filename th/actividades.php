...
function cmp_actividades(){
    ...
    $w = 'actividades';
    $o = 'contratoinfo';
    $c[] = new cmp($o,'e',null,'INFORMACIÓN DE ACTIVIDADES',$w);
     ...
     if ($a == 'actividades' && $b == 'acciones') {
        ...
        $accionesDisponibles = [
            'editar' => [
                ...
                'permiso' => true,
                'hash' => $hash_id,
                'evento' => "mostrar('actividades','pro',event,'{$hash_id}','actividades.php',7).then(() => getData('actividades', event, this, ['actividad'], 'actividades.php'));"
