...
function cmp_actividades(){
    ...
    $w = 'actividades';
    $o = 'actividadinfo';
   $rta .= '<div class="search-wrapper"><input type="number" class="number-input-svg" placeholder="Número a buscar..." step="0.1">
    ...
    $c[] = new cmp('actividad','nu','999',$d['actividad'],$w.' '.$o,'Actividad/Intervención','actividad',null,null,true,true,'','col-4');
