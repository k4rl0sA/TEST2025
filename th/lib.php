...
$rta="";
 ...
 $c[]=new cmp('tipo_doc','t','3','',$w.' '.$o,'Tipo documento','tipo_doc',null,null,false,true,'','col-4');
 $c[]=new cmp('documento','nu','999999999999999999','',$w.' '.$o,'NÚMERO DE DOCUMENTO','documento',null,null,false,true,'','col-2');
 $c[]=new cmp($o,'l',null,'',$w);
