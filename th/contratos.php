...
function cmp_contratos(){
    ...
    $c[] = new cmp('fecha_expe','d','',$d['fecha_expe'],$w.' GlIn '.$o3,'Fecha del Certificado','fecha_expe',null,null,false,false,'','col-3',"validDate(this,-3650,0);");
    $c[] = new cmp('semestre','nu','1',$d['semestre'],$w.' GlIn '.$o3,'Semestres Cursados','semestre',null,null,false,false,'','col-2');
