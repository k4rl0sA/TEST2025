...
function cmp_planillas(){
    ...
    $c[]= new cmp('colaborador','s',20,$d['colaborador'] ,$w.' uSR '.$o, 'Colaborador','colaborador','','',false,true,'','col-35',"cargarResumenFamiliar();");//  ,"enabDepeValu('perfil','uSR');cargarResumenIndivi();
