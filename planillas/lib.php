...
// var_dump($rta);
	if ($a=='planillas' && $b=='acciones'){
        ...
        $rta.="<li title='Editar'><i class='fa-regular fa-edit ico' id='".$c['ACCIONES']."' Onclick=\"mostrar('planillas','pro',event,'','lib.php',7).then(()=>getData('planillas',event,this,['evento'],'lib.php'));\"></i></li>";  
		$rta.="</nav>";
	}
 return $rta;
}
