...
function cmp_rutclasif(){
 $rta="";
 $t=['id_rutclas'=>'','idrutges'=>'','preclasif'=>'','clasifica'=>'','tiposeg'=>'','riesgo'=>'','accion'=>'','fecha'=>'','accion1'=>'','desc_accion1'=>'','accion2'=>'','desc_accion2'=>'','accion3'=>'','desc_accion3'=>'','profesional'=>'','solic_agend'=>'','ruta'=>'','sectorial'=>'','intsectorial'=>'','entornos'=>'','aseguram'=>''];
 $w='rutclasif';
 $d=get_rutclasif();
 if ($d=="") {$d=$t;}
...
function get_rutclasif(){
	if($_POST['id']=='0'){
		...
		$id=divide($_POST['id']);
		// var_dump($id);
		$sql="SELECT id_rutclas,idrutges,preclasif,clasifica,tiposeg,riesgo,accion,fecha,accion1,desc_accion1,accion2,desc_accion2,accion3,desc_accion3,fecha,docu_confirm,profesional,solic_agend,ruta,sectorial,intsectorial,entornos,aseguram,fecha_agenda,accion_1,fecha_agenda1,profesional1,accion_2,docu_confirm,tipo
