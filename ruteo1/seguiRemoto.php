...
function cmp_seguiremoto(){
  ...
  $c[] = new cmp('nov_pri_fam1','s','50',$d,$w.' GeS '.$o,'Novedad Prioridad Familiar 1','novedad1',null,null,false,$u,'','col-2');
  $c[] = new cmp('gestante_cpn','s','3',$d,$w.' GeS '.$o,'Gestante asiste a CPN','rta',null,null,false,$u,'','col-2');
  $c[] = new cmp('nov_pri_fam2','s','50',$d,$w.' GeS '.$o,'Novedad Prioridad Familiar 2','novedad2',null,null,false,$u,'','col-2');
  
  $c[]=new cmp($o,'l',null,'MENOR DE 5 AÑOS',$w);
  $c[] = new cmp('nov_pri_fam3','s','50',$d,$w.' m5A '.$o,'Novedad Prioridad Familiar 3','novedad3',null,null,false,$u,'','col-2');
...
$id = divide($_POST['id']);
    $sql = "INSERT INTO ruteo_remoto (
     ...
     $params = [
        ...
        ['type' => 's', 'value' => is_null('fecha_seg')],
        ['type' => 'i', 'value' => is_null('numsegui')],
        ['type' => 's', 'value' => is_null('estado_s')],
        ['type' => 's', 'value' => is_null('motivo_estado')],
        ['type' => 's', 'value' => is_null('gestante')],
        ['type' => 's', 'value' => is_null('menor5')],
        ['type' => 's', 'value' => is_null('cronico')],
        ['type' => 's', 'value' => is_null('general')],
        ['type' => 's', 'value' => is_null('nov_pri_fam1')],
        ['type' => 's', 'value' => is_null('gestante_cpn')],
        ['type' => 's', 'value' => is_null('nov_pri_fam2')],
        ['type' => 's', 'value' => is_null('menor5_rpms')],
        ['type' => 's', 'value' => is_null('menor5_riesgo')],
        ['type' => 's', 'value' => is_null('nov_pri_fam3')],
        ['type' => 's', 'value' => is_null('inasistente_12m')],
        ['type' => 's', 'value' => is_null('inasistente_6_12m')],
        ['type' => 's', 'value' => is_null('persona_mayor')],
        ['type' => 's', 'value' => is_null('persona_discapacidad')],
        ['type' => 's', 'value' => is_null('salud_mental')],
        ['type' => 's', 'value' => is_null('nuevo_diagnostico')],
        ['type' => 's', 'value' => is_null('ningun_diagnostico')],
        ['type' => 's', 'value' => is_null('vacunacion_incompleta')],
        ['type' => 's', 'value' => is_null('acepta_vacunacion')],
        ['type' => 's', 'value' => is_null('barrera_salud')],
        ['type' => 's', 'value' => is_null('agendamiento')],
        ['type' => 's', 'value' => is_null('activacion_ruta')],
        ['type' => 's', 'value' => is_null('sin_afiliacion')],
        ['type' => 's', 'value' => is_null('acepta_afiliacion')],
        ['type' => 's', 'value' => is_null('sujeto_abordaje')],
        ['type' => 's', 'value' => is_null('acepta_abordaje')],
        ['type' => 's', 'value' => is_null('deriva_perfil1')],
        ['type' => 's', 'value' => is_null('asignado_a1')],
        ['type' => 's', 'value' => is_null('sujeto_concertacion')],
        ['type' => 's', 'value' => is_null('acepta_plan')],
        ['type' => 's', 'value' => is_null('deriva_perfil2')],
        ['type' => 's', 'value' => is_null('asignado_a2')],
        ['type' => 's', 'value' => is_null('accion1')],
        ['type' => 's', 'value' => is_null('desc_accion1')],
        ['type' => 's', 'value' => is_null('accion2')],
        ['type' => 's', 'value' => is_null('desc_accion2')],
        ['type' => 's', 'value' => is_null('accion3')],
        ['type' => 's', 'value' => is_null('desc_accion3')],
        ['type' => 's', 'value' => is_null('observaciones')],
        ['type' => 's', 'value' => is_null('continua_seguimiento')],
        ['type' => 's', 'value' => is_null('fecha_prox_seguimiento')],
        ['type' => 's', 'value' => is_null('motivo_no_continuidad')],
