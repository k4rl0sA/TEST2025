...
function cmp_seguiremoto(){
 ...
 if ($e=="") {$e=$t;}
  ...
  $c[] = new cmp('sin_afiliacion','s','3',$d,$w.' '.$o,'Algun integrante de la familia se encuentra sin afiliacion al SGSS y cumple con criterios para afiliacion por oficio','rta',null,null,false,$u,'','col-4',"enabRutRmtAfi();");
