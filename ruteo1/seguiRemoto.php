...
function cmp_seguiremoto(){
 ...
 if ($e=="") {$e=$t;}
  ...
  $c[] = new cmp('deriva_perfil1','s','50',$d,$w.' FaS '.$o,'Perfil al que se deriva','perfil',null,null,false,$u,'','col-2',"selectDepend('deriva_perfil1','asignado_a1','seguiRemoto.php');");
  $c[] = new cmp('asignado_a1','s','50',$d,$w.' FaS '.$o,'Asignado A:','nombre',null,null,false,$u,'','col-3');
  ...
  $c[] = new cmp('deriva_perfil2','s','50',$d,$w.' ApS '.$o,'Perfil al que se deriva','perfil',null,null,false,$u,'','col-2',"selectDepend('deriva_perfil2','asignado_a2','seguiRemoto.php');");
  $c[] = new cmp('asignado_a2','s','50',$d,$w.' ApS '.$o,'Asignado A:','nombre',null,null,false,$u,'','col-3');
